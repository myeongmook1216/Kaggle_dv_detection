...
c_p_w = torch.load('C:/Users/kangm/PycharmProjects/Kaggle_competition/25/checkpoint/179ep_ACC_0.9733.pth') ###################### 바꿔라
...
test_df.to_csv('C:/Users/kangm/PycharmProjects/Kaggle_competition/25/test_result_25.csv', index=False)
